...
public class Paging {
	...
	public Paging(int currentPage, int totalCount, int pageSize) { // 외부(비지니스로직)에서 결정하고 전달되는값.
		...
		// 예시
		// totalCount = 367개이다. 그러면, pageSize=20 일  totalPage =19 , pageSize=10 일 
		// totalPage =37
		// totalCount = 7개이다. 그러면, pageSize=20 일  totalPage =1 , pageSize=10 일 
		// totalPage =1
		// totalCount = 200개이다. 그러면, pageSize=20 일  totalPage =10 , pageSize=10 일 
		// totalPage =20
